...
# Ensure session state variable for sidebar state
if "sidebar_collapsed" not in st.session_state:
    st.session_state["sidebar_collapsed"] = False  # Default: Sidebar expanded

# ✅ Insert only one menu toggle button right after the title
if st.button("☰ Toggle Sidebar", key="sidebar_toggle_button", help="Show/Hide Sidebar"):
...
st.markdown("""
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Auto-collapse sidebar when the page loads on mobile
            autoCollapseSidebar();
...
st.markdown("""
    ...
    <div class="marquee-container">
        Track your business prospects in real-time   |   Data-driven insights   |   Sales pipeline optimization!!   🔥✨
    </div>
""", unsafe_allow_html=True)
...
# ✅ Unique Key for Add Prospect Form
with st.sidebar.expander("➕ Add New Business Prospect", expanded=False):
    with st.form("add_prospect_form_sidebar"):  # Changed key to be unique
...
# ✅ Ensure session state variable for sidebar toggle
if "sidebar_collapsed" not in st.session_state:
    st.session_state["sidebar_collapsed"] = False  # Default: Sidebar is expanded

# ✅ Unique Key for Sidebar Toggle Button
